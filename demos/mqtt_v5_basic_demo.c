...
int main(int argc, char *argv[])
{
    ...
    char *url = "iot-cn-6ja1w0x6h17.mqtt.iothub.aliyuncs.com"; /* MQTT 5.0的接入企业实例点. TODO: 用户需要将其替换为自己企业实例接入点 */
    ...
    /* TODO: 替换为自己设备的三元组 */
    char *product_key       = "g1namrqiS1h";
    char *device_name       = "mqtt_v5_demo_device";
    char *device_secret     = "7a34b94dc12921c516a60d26c3512f05";
    ...
    */
...
#if 0
    {
        char *sub_topic = "/sys/g1namrqiS1h/mqtt_v5_demo_device/user/update";
    ...
    {
        char *pub_topic = "/sys/g1namrqiS1h/mqtt_v5_demo_device/thing/event/property/post";
